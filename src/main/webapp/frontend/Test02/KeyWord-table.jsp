...
<!-- Bootstrap core CSS -->
<link
	href="<%=request.getContextPath()%>/frontend/Test02/assets/css/bootstrap.css"
	rel="stylesheet">
<!--external css-->
<link
	href="<%=request.getContextPath()%>/frontend/Test02/assets/font-awesome/css/font-awesome.css"
	rel="stylesheet" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/frontend/Test02/assets/css/zabuto_calendar.css">
<!-- <link rel="stylesheet" type="text/css" href="assets/js/gritter/css/jquery.gritter.css" /> -->
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/frontend/Test02/assets/lineicons/style.css">
<!-- Custom styles for this template -->
<link
	href="<%=request.getContextPath()%>/frontend/Test02/assets/css/style.css"
	rel="stylesheet">
<link
	href="<%=request.getContextPath()%>/frontend/Test02/assets/css/style-responsive.css"
	rel="stylesheet">
<link
	href="<%=request.getContextPath()%>/frontend/Test02/assets/css/fq-keyword.css"
	rel="stylesheet">

<!-- <script -->
<%-- src="<%=request.getContextPath()%>/frontend/Test02/assets/js/chart-master/Chart.js"> --%>
<!-- </script> -->
