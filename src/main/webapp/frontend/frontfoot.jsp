...
<body>
    ...
    <!--bootstrap-->
    <script src="<%=request.getContextPath()%>/frontend/mainCss/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- owl-carousel -->
    <script src="<%=request.getContextPath()%>/frontend/mainCss/assets/vendor/slick/slick.min.js"></script>
    <!-- magnific -->
    <script src="<%=request.getContextPath()%>/frontend/mainCss/assets/vendor/magnific/jquery.magnific-popup.min.js"></script>
    <!-- isotope -->
    <script src="<%=request.getContextPath()%>/frontend/mainCss/assets/vendor/isotope/isotope.pkgd.min.js"></script>
    <!-- count-down -->
