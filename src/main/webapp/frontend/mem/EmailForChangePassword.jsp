...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/mem/SendMailForgetPasswordServlet" name="form1">
 ...
 <div>
 	...
 	<div class="form-group mb-3">
             <div class="row align-items-center">
                <label class="form-label col" for="memEmail"  color: cadetblue;>請輸入您的信箱: 
                <span class="text-danger">*</span></label>
                  </div>
					<input type="text" class="form-control" id="memEmail" placeholder="輸入信箱"
                         style="text-transform: none;" name="memEmail"> 
                  </div>
