...
<body>
	...
	<div id="forum-content"
		...
		<div style="display: inline-block;">
			<a href="<%=request.getContextPath()%>/backend/forum/selectReportHome.jsp">
				<button>返回檢舉首頁</button>
			</a>
		</div>
		<div style="display: inline-block;">
			<a href="<%=request.getContextPath()%>/backend/forum/listAllForumPostReport.jsp">
		...
		<table class="showPanel" style="table-layout: fixed; color: black;">
			...
			<tr>
				...
				<td>${forumPostReportVO.forumPostReportWhy}&emsp;</td>
				<td><fmt:formatDate
