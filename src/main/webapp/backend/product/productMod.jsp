      ...
      *********************************************************************************************************************************************************** -->
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div id="app">
                                ...
                                <card-template :read-data="renderData" :now-page="nowPage" v-on:emitedit="edit">
                                </card-template>
                                ...
                                <div style="width: 30%;">
                                    <form v-if="isNew || temp.productNo" method="post"
                                        action="/CGA101G1/product/GetParameter" enctype="multipart/form-data" required>
                                        ...
                                        <div>
                                            <label for="productPrice" class="form-label">價格</label> <input type="number"
                                                ...
                                                v-model="temp.productPrice" @change="priceCheck($event)">
                                            <div style="color: red;"
                                        ...
                                        <div>
                                            <label for="productState" class="form-label">銷售狀態</label> <input
                                                ...
                                                id="productStateS" name="ProductState" v-model="temp.productState"
                                                value="1"> <label for="productStateS" class="form-label">已上架</label>
                                        </div>
                                        <div>
                                            <label for="gameTypeNo" class="form-label">遊戲種類</label> <select
                                                name="GameTypeNo" id="gameTypeNo" v-model="temp.gameTypeNo" required>
                                        ...
                                        <div>
                                            <label for="gamePlatformNo" class="form-label">遊戲平台種類</label> <select
                                                name="GamePlatformNo" id="gamePlatformNo" v-model="temp.gamePlatformNo"
                                                required>
                                        ...
                                        <div>
                                            <label for="gameCompanyNo" class="form-label">遊戲公司</label> <select
                                                name="GameCompanyNo" id="gameCompanyNo" v-model="temp.gameCompanyNo"
                                                required>
                                        ...
                                        <div>
                                            <label for="upcNum" class="form-label">UpcNum</label> <input type="number"
                                                id="upcNum" name="UpcNum" class="form-control" v-model="temp.upcNum"
                                                required @change="upcNumCheck($event)" maxlength="50">
                                            <div style="color: red;"
                                        ...
                                        <div>
                                            ...
                                            <textarea name="ItemProdDescription" id="itemProdDescription" cols="55"
                                                rows="20" required>{{temp.itemProdDescription}}</textarea>
                                        </div>


                                        <div>
                                            <label v-if="url2" class="form-label">封面照片編號</label> <input v-if="url2"
                                                type="text" name="productImage1NO" class="form-control"
                                        ...
                                        <div>
                                            <label v-if="url2" class="form-label">產品圖片2編號</label> <input v-if="url2"
                                                type="text" name="productImage2NO" class="form-control"
                                        ...
                                        <div>
                                            <label v-if="url3" class="form-label">產品圖片3編號</label> <input v-if="url3"
                                                type="text" name="productImage3NO" class="form-control"
            ...
            <footer class="site-footer">
                <div class="text-center">
                    2014 - Alvarez.is <a href="blank.html#" class="go-top"> <i class="fa fa-angle-up"></i>
                    </a>
                </div>
            </footer>
            <!--footer end-->
