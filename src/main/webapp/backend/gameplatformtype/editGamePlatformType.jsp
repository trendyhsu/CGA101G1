...
<!-- 		主要修改資訊區 -->
		...
		<form method="post"
			action="<%=request.getContextPath()%>/gameplatformtype/gamePlatformTypeEdit"
			...
			<table>
				<tr>
					...
					<td>原遊戲平台種類</td>
					<td><select name="gamePlatformNo" size="1">   <!-- -->
						<c:forEach var="gamePlatformTypeVO" items="${list}">
						<option value="${gamePlatformTypeVO.gamePlatformNo}">${gamePlatformTypeVO.gamePlatformName}
						</c:forEach>
						</select>
					</td>
