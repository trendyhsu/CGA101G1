...
//			}
			...
			List<BidPicVO> originalList = bidPicSvc.getAllBidPicByBidProductNo(bidProductNo);
			request.setAttribute("list", originalList);

			// Send the use back to the form, if there were errors
			if (!errorMsgs.isEmpty()) {
				request.setAttribute("bidProductVO", bidProductVO); // bidProductVO物件,也存入req
